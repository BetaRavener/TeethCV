...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.levelSlider = QtWidgets.QSlider(Dialog)
        ...
        self.levelSlider.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 198, 517))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Sampling level"))
